	...
	public static void main(String[] args) throws Exception {
		...
		do { // GIU
			...
			case 1:
				...
				File karton = new File("Kartoni/" + account.getName()); // pravljenje
				// korisnikovog
				// kartona
				...
				kartica = new File("Kartice/" + account.getName());
			...
			case 2:
				if (users.isEmpty()) {
					...
					if (opcijaPrijave == 1) {
						...
						// Simulirat cemo ubacivanje kartice u bankomat tako sto ce korisnik upisati
						// svoje ime, pa cemo po tome naci karticu
						System.out.println("Upisite svoje ime: ");
						String imeKorisnika = inputString.next();
						File korisnik = new File("Kartice/" + imeKorisnika);
					...
					case 1:
						...
						do {
							...
							if (money > source.getBalance()) {
								System.out.println(
										"Nemate dovoljno sredstava na racunu, probajte sa nekim manjim iznosom!");
							}
